...
QT_MOC_LITERAL(1, 14, 12), // "ParaAccepted"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 7), // "success"
QT_MOC_LITERAL(4, 36, 23), // "Slot_ConfirmBtn_clicked"
QT_MOC_LITERAL(5, 60, 28) // "Slot_LoadFromFileBtn_clicked"

    },
    "configuration\0ParaAccepted\0\0success\0"
    "Slot_ConfirmBtn_clicked\0"
    "Slot_LoadFromFileBtn_clicked"
};
...
void configuration::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->ParaAccepted((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 1: _t->Slot_ConfirmBtn_clicked(); break;
        case 2: _t->Slot_LoadFromFileBtn_clicked(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (configuration::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&configuration::ParaAccepted)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void configuration::ParaAccepted(bool _t1)
{
